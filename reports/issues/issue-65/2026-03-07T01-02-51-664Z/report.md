...
- Scan duration: 13.2 minutes
- Total URLs submitted: 100
- Accepted public URLs: 100
- Rejected URLs: 0
- 🌙 **Dark mode tested: 98 of 100 URLs (98%) support `prefers-color-scheme: dark`**
- ALFA outcomes: 8600 passed, 386 failed, 111 cantTell, 6246 inapplicable
- axe outcomes: 12436 passed, 212 failed, 6 cantTell, 12628 inapplicable
- Equal Access outcomes: 20180 passed, 679 failed (671 unique, 8 duplicate), 346 cantTell, 0 inapplicable
- AccessLint outcomes: 8996 passed, 204 failed (204 unique, 0 duplicate), 0 cantTell, 0 inapplicable
- QualWeb outcomes: 3964 passed, 196 failed, 393 cantTell, 104 inapplicable
- Duplicate findings caught by later scanners: 131
...
|---|---:|---:|---:|---:|---:|---:|---|
| [View Page](https://georgia.gov/how-do-i-find-equity-and-accessibility-resources-disability-services) | 8 | 19 | 46 | 2 | 0 | **75** | Find Equity and Accessibility Resources for Disability Services \| Georgia.gov |
| [View Page](https://georgia.gov/how-do-i-find-equity-and-accessibility-resources-consumer-services) | 8 | 19 | 37 | 2 | 0 | **66** | Find Equity and Accessibility Resources for Consumer Services \| Georgia.gov |
| [View Page](https://georgia.gov/how-do-i-collect-child-support) | 2 | 31 | 6 | 2 | 2 | **43** | Just a moment... |
| [View Page](https://georgia.gov/) | 2 | 2 | 6 | 3 | 2 | **15** | Just a moment... |
| [View Page](https://georgia.gov/locations/georgia-dhs-division-aging-services-0) | 2 | 2 | 6 | 3 | 2 | **15** | Just a moment... |
| [View Page](https://georgia.gov/alicia-m-johnson) | 2 | 2 | 6 | 3 | 2 | **15** | Just a moment... |
| [View Page](https://georgia.gov/barbara-rivera-holmes) | 2 | 2 | 6 | 3 | 2 | **15** | Just a moment... |
| [View Page](https://georgia.gov/how-do-i-find-equity-and-accessibility-resources-veterans-services) | 2 | 2 | 6 | 2 | 2 | **14** | Just a moment... |
| [View Page](https://georgia.gov/how-do-i-find-aging-equity-and-accessibility-resources) | 2 | 2 | 6 | 2 | 2 | **14** | Just a moment... |
| [View Page](https://georgia.gov/how-do-i-find-equity-and-accessibility-resources-assistance-programs) | 2 | 2 | 6 | 2 | 2 | **14** | Just a moment... |
...
|---|---:|---|
| [SIA-R9](https://alfa.siteimprove.com/rules/sia-r9) | **97** of 100 | [View Rule](https://alfa.siteimprove.com/rules/sia-r9) |
| [SIA-R96](https://alfa.siteimprove.com/rules/sia-r96) | **97** of 100 | [View Rule](https://alfa.siteimprove.com/rules/sia-r96) |
| [SIA-R111](https://alfa.siteimprove.com/rules/sia-r111): Interactive elements have a sufficient target size | **3** of 100 | [View Rule](https://alfa.siteimprove.com/rules/sia-r111) |
| [SIA-R56](https://alfa.siteimprove.com/rules/sia-r56): Landmarks with the same role are distinguishable | **3** of 100 | [View Rule](https://alfa.siteimprove.com/rules/sia-r56) |
| [SIA-R57](https://alfa.siteimprove.com/rules/sia-r57): Landmarks don't repeat the same content | **3** of 100 | [View Rule](https://alfa.siteimprove.com/rules/sia-r57) |
| [SIA-R61](https://alfa.siteimprove.com/rules/sia-r61) | **3** of 100 | [View Rule](https://alfa.siteimprove.com/rules/sia-r61) |
...
| [SIA-R87](https://alfa.siteimprove.com/rules/sia-r87): First focusable element is a skip link | **3** of 100 | [View Rule](https://alfa.siteimprove.com/rules/sia-r87) |
...
| Rule | Pages Affected | Documentation |
|---|---:|---|
| meta-refresh | **98** of 100 | [View Rule](https://dequeuniversity.com/rules/axe/4.11.1/meta-refresh) |
| landmark-no-duplicate-banner | **2** of 100 | [View Rule](https://dequeuniversity.com/rules/axe/4.11.1/landmark-no-duplicate-banner) |
| landmark-unique | **2** of 100 | [View Rule](https://dequeuniversity.com/rules/axe/4.11.1/landmark-unique) |
| region | **2** of 100 | [View Rule](https://dequeuniversity.com/rules/axe/4.11.1/region) |
| tabindex | **2** of 100 | [View Rule](https://dequeuniversity.com/rules/axe/4.11.1/tabindex) |
...
2. Press F12 to open DevTools
3. Go to Console tab
4. Run: `$x('/button[@class="header-search-trigger__button header-search-trigger__button--open js-search-open"]')`
5. The element will be highlighted
...
2. Press F12 to open DevTools
3. Go to Console tab
4. Run: `$x('/button[@class="ivy-chat-icon ivy-chat-icon-cancel ivy-chat-close"]')`
5. The element will be highlighted
...
2. Press F12 to open DevTools
3. Go to Console tab
4. Run: `$x('/a[@class="header-utility-wide__agency-selector"]')`
5. The element will be highlighted
...
2. Press F12 to open DevTools
3. Go to Console tab
4. Run: `$x('/a[@class="breadcrumb__link"]')`
5. The element will be highlighted
...
2. Press F12 to open DevTools
3. Go to Console tab
4. Run: `$x('/a[@class="footer-social__icon-link"]')`
5. The element will be highlighted
...
2. Press F12 to open DevTools
3. Go to Console tab
4. Run: `$x('/a[@class="footer-link-group__list-item-link"]')`
5. The element will be highlighted
...
- HTML: `<button aria-label="Close chat" tabindex="0" aria-hidden="false" class="ivy-chat-icon ivy-chat-icon-cancel ivy-chat-close">...</button>`
- XPath: `/button[@class="ivy-chat-icon ivy-chat-icon-cancel ivy-chat-close"]`

**Failure 2:**
- Message: Target has insufficient size
- HTML: `<a id="block-ga-bloom-googletranslator" href="#" class="notranslate google-translator-switch header-utility-wide__language-selector" data-once="google-translate-disclaimer-init">...</a>`
- XPath: `/a[@id="block-ga-bloom-googletranslator"]`

**Failure 3:**
- Message: Target has insufficient size
- HTML: `<a class="header-utility-wide__agency-selector" href="https://georgia.gov/state-organizations">...</a>`
- XPath: `/a[@class="header-utility-wide__agency-selector"]`

**Failure 4:**
- Message: Target has insufficient size
- HTML: `<button class="header-search-trigger__button header-search-trigger__button--open js-search-open" type="button">...</button>`
- XPath: `/button[@class="header-search-trigger__button header-search-trigger__button--open js-search-open"]`

**Failure 5:**
- Message: Target has insufficient size
- HTML: `<a href="/" class="breadcrumb__link">...</a>`
...
- HTML: `<p>I'm a virtual assistant and I can help answer your...</p>`
- XPath: `/p`

**Failure 2:**
- Message: The line height of the paragraph is `normal` which will result in a line height of less than 1.5
- HTML: `<p class="header-official-site__description-text">...</p>`
...
**Failure 4:**
- Message: The line height of the paragraph is `normal` which will result in a line height of less than 1.5
- HTML: `<p class="alert__body">We'll never request payment or info through unsoli...</p>`
- XPath: `/p[@class="alert__body"]`

**Failure 5:**
- Message: The line height of the paragraph is `normal` which will result in a line height of less than 1.5
- HTML: `<p class="heading-lockup__label" style="--text-color: var(--dark-text); --link-color-default: var(--link-color-default-dark); --link-color-hover: var(--link-color-hover-dark); --link-color-focus: var(--link-color-focus-dark); --link-color-active: var(--link-color-active-dark); --link-color-visited: var(--link-color-visited-dark)">       How Do I …     </p>`
...
**Failure 2:**
- Message: Target has insufficient size
- HTML: `<a id="block-ga-bloom-googletranslator" href="#" class="notranslate google-translator-switch header-utility-wide__language-selector">...</a>`
- XPath: `/a[@id="block-ga-bloom-googletranslator"]`
...
**Failure 5:**
- Message: Target has insufficient size
- HTML: `<button class="mobile-nav-button" data-drupal-selector="mobile-nav-button" aria-label="Main Menu" aria-controls="header-nav" aria-expanded="false">...</button>`
...
**Failure 2:**
- Message: Target has insufficient size and spacing
- HTML: `<a href="/services" class="primary-nav__menu-link primary-nav__menu-link--link primary-nav__menu-link--level-1" data-drupal-selector="primary-nav-menu-link-has-children" data-drupal-link-system-path="services">...</a>`
- XPath: `/a[@class="primary-nav__menu-link primary-nav__menu-link--link primary-nav__menu-link--level-1"]`

**Failure 3:**
- Message: Target has insufficient size and spacing
- HTML: `<a href="#" class="header-search-form__popular-choice-link">Mission Statement</a>`
- XPath: `/a[@class="header-search-form__popular-choice-link"]`

**Failure 4:**
- Message: Target has insufficient size and spacing
- HTML: `<a class="how-do-i-step-links__list-item-link" href="#hdi-20396-step-1">           Get Prepared         </a>`
- XPath: `/a[@class="how-do-i-step-links__list-item-link"]`

**Failure 5:**
- Message: Target has insufficient size and spacing
- HTML: `<a class="footer-link-group__list-item-link" href="https://georgia.gov/state-organizations">                   State Organizations            ...</a>`
