...
<body>
  ...
  <div class="container" id="main-content" tabindex="-1">
    ...
    <footer>
      <p>Generated by <a href="https://github.com/mgifford/alt-text-scan" target="_blank" rel="noopener noreferrer">alt-text-scan</a> — an open-source accessibility scanning tool.</p>
    </footer>
  </div>
  ...
  <script>
    ...
    function buildFailureDetails(el) {
      ...
      return [
        ...
        '====',
        '',
        \`This accessibility issue was found using \${engineLabel} and https://github.com/mgifford/alt-text-scan/\`
      ].join('\\n');
    }
